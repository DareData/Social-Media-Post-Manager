    ...
    <div className="sticky top-0 z-40 bg-background/70 shadow-sm backdrop-blur-md">
      <div className="flex flex-nowrap items-center justify-between gap-2 px-3 py-3 sm:gap-3 sm:px-6 sm:py-4">
        <h1 className="flex min-w-0 flex-1 items-center gap-2 truncate text-2xl font-bold tracking-tight sm:flex-none sm:text-4xl">
          ...
          <span>
            Bu
            <span className="inline-block text-amber-500 dark:text-amber-400 [transform:rotate(-3deg)]">z</span>
            <span className="inline-block text-[0.85em] text-amber-500 dark:text-amber-400 [transform:translateY(0.02em)_rotate(-6deg)]">Z</span>
            <span className="mx-[0.01em] inline-block text-[1.08em] text-amber-500 dark:text-amber-400 [transform:translateY(-0.16em)_rotate(7deg)]">z</span>
            y
          </span>
        </h1>
